import 'package:app1/RegistroTienda.dart';
import 'package:app1/ShopList.dart';
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                      context, MaterialPageRoute(builder: (_) => ShopList()));
                },
            ...
            Padding(
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                      context, MaterialPageRoute(builder: (_) => RegistroTienda()));
                },
